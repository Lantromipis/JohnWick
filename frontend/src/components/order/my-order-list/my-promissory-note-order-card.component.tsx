...
type MyPromissoryNoteOrderCardProps = {
  order: PromissoryNoteOrderDto;
};

const MyPromissoryNoteOrderCardComponent: FC<
  MyPromissoryNoteOrderCardProps
> = ({ order }) => {
  return (
...
export default memo(MyPromissoryNoteOrderCardComponent);
